    ...
    <div id="lead">
      <ul class="guide">
        ...
        <li  class="link"><a href='#'>招考动态</a>
          <ul style="display: none;"class='menu'>
            <li><a href='dynamic/news.show.php'>招生快讯</a></li>
            <li><a href='dynamic/information.show.php'>重要资讯</a></li>
            <li><a href='dynamic/report.show.php'>媒体报道</a></li>
            <li><a href='dynamic/admission.show.php'>录取查询</a></li>
          </ul>
        </li>
...
<div id="content">
  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	...
	<p class="block-title">
	<span class="title">重要资讯&nbsp></span>
	<a href="dynamic/information.show.php" class="more"><span class="more">more..</span></a>
	</p>
	<?php 
	
	require_once('article/connect.php');
	$sql = "select * from article where author='admin1'";//id>38 and id<43
...
?>
	...
	?>
			...
			<div class="meta1">
				<div class="links" style="white-space:nowrap;text-overflow:ellipsis;overflow:hidden;width:280px; float:left;line-height:2;margin:0px 5px;"   > <a href="introduction/show1.php?id=<?php echo $value['id']?>" class="more" ><?php	echo $value['title']?></a></div><div style="float: right; color: black;line-height:2;margin:0px 5px;" class="time"><span class="time"><?php echo date("Y-m-d", $value['dateline']) ;?></span></div>
	...
	<div class="plate admission">
	<p class="block-title">
	<span class="title">招生快讯&nbsp></span>
	<a href="dynamic/information.show.php" class="more"><span class="more">more..</span></a>
	</p>
	<?php 
	
	require_once('article/connect.php');
	$sql = "select * from article where author='admin2'";//id>35 and id<39
	$query = mysqli_query($con,$sql);
	if($query&&mysqli_num_rows($query)){
		while($row = mysqli_fetch_assoc($query)){
			$data2[] = $row;
...
?>
	...
	?>
			...
			<div class="meta1">
				<div class="links" style="white-space:nowrap;text-overflow:ellipsis;overflow:hidden;width:240px; float:left;line-height:2;margin:0px 5px;"   > <a href="introduction/show1.php?id=<?php echo $value['id']?>" class="more" ><?php	echo $value['title']?></a></div><div style="float: right; color: black;line-height:2;margin:0px 5px;" class="time"><span class="time"><?php echo date("Y-m-d", $value['dateline']) ;?></span></div>
	...
	<p class="block-title">
	<span class="title">录取查询&nbsp></span>
	</p>
	<br /><br />
	<center>
	<a href="dynamic/admission.show.php"><img src="image/admission1.jpg" /></a>
	</center>
	</div>
	</div>
	...
	<div class="plate data">
	<p class="block-title">
	<span class="title">杭电生活&nbsp></span>
	<a href="dynamic/information.show.php" class="more"><span class="more">more..</span></a>
	</p>
	<?php 
	
	require_once('article/connect.php');
	$sql = "select * from article where id>27 and id<32";
	$query = mysqli_query($con,$sql);
	if($query&&mysqli_num_rows($query)){
		while($row = mysqli_fetch_assoc($query)){
			$data3[] = $row;
...
?>
	...
	<div class="plate admission">
	<p class="block-title">
	<span class="title">报考专栏&nbsp></span>
	<a href="dynamic/information.show.php" class="more"><span class="more">more..</span></a>
	</p>
	<?php 
