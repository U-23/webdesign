<?php 
	...
	$sql = "select * from article where id=19";
...
<div id="content">
  ...
  <div id="Licon">
    ...
    <div class="right">
      <p class="location"> 当前位置： <span> <a href='../index.php'>首页</a>- <a href='#'>院系纵览</a>- <a href='dshow7.php'>通信工程学院</a> </span> </p>
		...
		<div class="post">
			...
			<div class="entry">
				<p>
					...
					<a href="http://comm.hdu.edu.cn/"><span style="color:#e53333;font-size:16px;">http://comm.hdu.edu.cn/</span></a>
				</p>
			
				<p align="">
				<img title="" alt="" src="../image/dshow7.jpg" height="400" width="550">
				</p>
