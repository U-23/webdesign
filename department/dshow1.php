<?php 
	...
	$sql = "select * from article where id=13";
...
<div id="content">
  ...
  <div id="Licon">
    ...
    <div class="right">
      <p class="location"> 当前位置： <span> <a href='../index.php'>首页</a>- <a href='#'>院系纵览</a>- <a href='dshow1.php'>计算机学院</a> </span> </p>
		...
		<div class="post">
			...
			<div class="entry">
				<p>
					...
					<a href="http://computer.hdu.edu.cn/"><span style="color:#e53333;font-size:16px;">http://computer.hdu.edu.cn/</span></a>
				</p>
			
				<p align="">
				<img title="" alt="" src="../image/dshow1.jpg" height="400" width="550">
				</p>
