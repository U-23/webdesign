<?php 
	...
	$sql = "select * from article where id=22";
  ...
  <div id="lead">
    <ul class="guide">
      ...
      <li class="link"><a href='#'>院系纵览</a>
        <ul style="display: none;" class='menu'>
		    <li><a href='dshow1.php'>计算机学院</a></li>
            <li><a href='dshow2.php'>数字媒体与艺术设计学院</a></li>
			<li><a href='dshow3.php'>会计学院</a></li>
			<li><a href='dshow4.php'>外国语学院</a></li> 
			<li><a href='dshow5.php'>卓越学院</a></li>
			<li><a href='dshow6.php'>电子信息工程</a></li>
            <li><a href='dshow7.php'>通信工程学院</a></li> 
			<li><a href='dshow8.php'>软件工程学院</a></li>
            <li><a href='dshow9.php'>机械工程学院</a></li>
            <li><a href='dshow10.php'>人文与法学院</a></li>
        </ul>
      </li>
...
<div id="content">
  ...
  <div id="Licon">
    ...
    <div class="right">
      <p class="location"> 当前位置： <span> <a href='../index.php'>首页</a>- <a href='#'>院系纵览</a>- <a href='dshow10.php'>人文与法学院</a> </span> </p>
	 ...
	 <div class="content"> 
		...
		<div class="post">
			...
			<div class="entry">
				<p>
					<span style="color:#e53333;font-size:16px;">学院网址：</span>
					<a href="http://rwxy.hdu.edu.cn/home/index.php"><span style="color:#e53333;font-size:16px;">http://rwxy.hdu.edu.cn/home/index.php</span></a>
				</p>
			
				<p align="">
				<img title="" alt="" src="../image/dshow10.jpg" height="400" width="550">
				</p>
