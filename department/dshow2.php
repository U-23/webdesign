<?php 
	...
	$sql = "select * from article where id=14";
...
<div id="content">
  ...
  <div id="Licon">
    ...
    <div class="right">
      <p class="location"> 当前位置： <span> <a href='../index.php'>首页</a>- <a href='#'>院系纵览</a>- <a href='dshow2.php'>数字媒体与艺术设计学院</a> </span> </p>
		...
		<div class="post">
			...
			<div class="entry">
				<p>
					...
					<a href="http://syxy.hdu.edu.cn/"><span style="color:#e53333;font-size:16px;">http://syxy.hdu.edu.cn/</span></a>
				</p>
			
				<p align="">
				<img title="" alt="" src="../image/dshow2.jpg" height="400" width="550">
				</p>
