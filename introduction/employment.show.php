<?php 
	...
	$sql = "select * from article where id=8";
    ...
    <ul class="guide">
      ...
      <li class="link"><a href="#">学校介绍</a>
        <ul style="display: none;" class="menu">
          <li><a class="" href="introduction.show.php">学校概况</a></li>
          <li><a href="resources.list.php">师资力量</a></li>
          <li><a href="competition.show.php">学科竞赛</a></li>
           <li><a href="employment.show.php">就业情况</a></li>
            <li><a href="schoolfellow.show.php">优秀校友</a></li>
        </ul>
      </li>
...
<div id="content">
  ...
  <div id="Licon">
    <div class="left"> <img src="../image/cont1.jpg">
      <ul>
        <li class='now'><a href='introduction.show.php'>学校概况</a></li>
        <li><a href='resources.list.php'>师资力量</a></li>
        <li><a href='competition.show.php'>学科竞赛</a></li>
        <li><a href="employment.show.php">就业情况</a></li>
            <li><a href="schoolfellow.show.php">优秀校友</a></li>
    ...
    <div class="right">
      <p class="location"> 当前位置： <span> <a href='../index.php'>首页</a>- <a href='#'>学校介绍</a>- <a href='employment.show.php'>就业情况</a> </span> </p>
	 ...
	 <div class="content"> 
		...
		<div class="post">
			...
			<div class="entry">
				<p align="center">
				<img title="" alt="" src="../image/employ1.jpg" height="400" width="550">
				</p>
				<p align="center">&nbsp;</p>
				<p align="center">
				<img title="" alt="" src="../image/employ2.jpg" height="400" width="550">
				</p>
