<?php 
	...
	$sql = "select * from article where id>8 and id<13";
...
<div id="content">
  ...
  <div id="Licon">
    ...
    <div class="right">
      <p class="location"> 当前位置： <span> <a href='../index.php'>首页</a>- <a href='#'>学校介绍</a>- <a href='schoolfellow.show.php'>优秀校友</a> </span> </p>
	...
	?>
		<div class="post">
			<div class="meta">
				<p class="links"><a href="show1.php?id=<?php echo $value['id']?>" class="more"><?php	echo $value['title']?></a></p>
					<p > <b><hr/></b> </p>
			</div>
		</div>
	<?php
