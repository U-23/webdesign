...
<div id="content">
  <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
	...
	<div class="art">
		...
		<div class="post">
			<h1 class="title"><!--文章标题放置到这里--><?php echo $row['title']?><span style="color:#ccc;font-size:14px;">　　作者：<!--作者放置到这里--><?php echo $row['author'];?></span><span>发表时间：<?php echo date("Y-m-d H:i:s", $row['dateline']) ;?></span></h1>
			<div class="entry">
				<!--文章内容放置到这里-->
