    ...
    <ul class="guide">
      ...
      <li class="link"><a href='#'>院系纵览</a>
       ...
       <li  class="link"><a href='#'>报考指南</a>
          <ul style="display: none;" class='menu'>
            <li><a href='policy.show.php'>招生政策</a></li>
            <li><a href='column.show.php'>报考专栏</a></li>
			<li><a href='plan.show.php'>招生计划</a></li>
			<li><a href='entrance.show.php'>普通高考</a></li>
			<li><a href='overyears.show.php'>历年录取</a></li>
          </ul>
        </li>
...
<div id="content">
  ...
  <div id="Licon">
    ...
    <div class="right">
      <p class="location"> 当前位置： <span> <a href='../index.php'>首页</a>- <a href='#'>报考指南</a>- <a href='entrance.show.php'>普通高考</a> </span> </p>
