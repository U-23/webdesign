<?php 
	...
	$sql = "select * from article where id>31 and id<35";
...
<div id="site">
  ...
  <div id="content">
    ...
    <div id="Licon">
      ...
      <div class="right">
        <p class="location"> 当前位置： <span> <a href='../index.php'>首页</a>- <a href='#'>招考动态</a>- <a href='admission.show.php'>录取查询</a> </span> </p>
        <div class="content">
			<div align="center" style="height:400px;background-color:#D3EAF7">
			<div align="center"><strong><font color="#990000">请输入姓名和考生号：</font></strong></div>
			<hr align="center" size="1" width="95%">
          <form action="admission.show.done.handle.php" method="post"  style="background-color: #D3EAF7;margin-top:20px">
            <table border="0">
              <tr align="center">
                <td colspan="2"><div style="border:0px solid red;z-index: 999;position: absolute;width: 40px;height: 35px;" class="hamburg-my-account"></div>
                  <p>
                    <label for="password"></label>
					考生号:
                    <input type="text" name="password" id="password" class="abc" placeholder="考生号"/>
                  </p>
                  <p>&nbsp;</p>
                  <p>
                    <label for="id"></label>
					姓名：
                    <input type="text" name="id" id="id" class="abc" placeholder="姓名"/>
                  </p>
				  <p>
              <input name="1" type="submit" class="button" id="1" value="提交查询">
            </p>
				  </td>
              </tr>
            </table>
